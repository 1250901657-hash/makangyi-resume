        ...
        <div className="surface px-6 py-8 md:px-10 md:py-10">
          <div className="grid gap-8 xl:grid-cols-[minmax(0,1.08fr)_minmax(250px,0.92fr)]">
            ...
            <div className="soft-card flex min-h-56 flex-col justify-between p-6">
              ...
              <p className="font-display text-[2rem] leading-[1.06] text-white">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              {siteContent.about.principles.map((item, index) => (
                <div key={item} className="soft-card px-4 py-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.18em] text-muted">
                    0{index + 1}
                  </p>
                  <p className="mt-2 text-sm leading-7 text-white/88">{item}</p>
                </div>
              ))}
            </div>
          </div>
